...
function check_num_var($varname)
{
    if (!is_numeric($_POST[$varname])) {
        return 280;
    } elseif ($_POST[$varname] == 0 && $varname == "settings_column_width_bookmark") {
        return 0;
    } elseif ($_POST[$varname] < 0) {
        return 0;
    } elseif ($_POST[$varname] > 800) {
        return 800;
    } else {
        ...
        <td valign="top">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_confirm_delete" <?php if ($settings['confirm_delete'] == 1) {
                            echo "checked";
                                                                              }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_open_new_window" <?php if ($settings['open_new_window'] == 1) {
                            echo "checked";
                                                                               }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_show_bookmark_description" <?php if ($settings['show_bookmark_description'] == 1) {
                            echo "checked";
                                                                                         }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_show_bookmark_icon" <?php if ($settings['show_bookmark_icon'] == 1) {
                            echo "checked";
                                                                                  }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_show_column_date" <?php if ($settings['show_column_date'] == 1) {
                            echo "checked";
                                                                                }?>>
                    </td>
                </tr>
                    ...
                    <td>
                        <select name="settings_date_format">
                            ...
                            foreach ($date_formats as $format_key => $format) {
                                ...
                                if ($settings['date_format'] == $format_key) {
                                    echo ' selected';
                                }
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_show_public" <?php if ($settings['show_public'] == 1) {
                            echo "checked";
                                                                           }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_show_column_edit" <?php if ($settings['show_column_edit'] == 1) {
                            echo "checked";
                                                                                }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_show_column_move" <?php if ($settings['show_column_move'] == 1) {
                            echo "checked";
                                                                                }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_show_column_delete" <?php if ($settings['show_column_delete'] == 1) {
                            echo "checked";
                                                                                  }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_fast_folder_minus" <?php if ($settings['fast_folder_minus'] == 1) {
                            echo "checked";
                                                                                 }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_fast_folder_plus" <?php if ($settings['fast_folder_plus'] == 1) {
                            echo "checked";
                                                                                }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_fast_symbol" <?php if ($settings['fast_symbol'] == 1) {
                            echo "checked";
                                                                           }?>>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="settings_simple_tree_mode" <?php if ($settings['simple_tree_mode'] == 1) {
                            echo "checked";
                                                                                }?>>
                    </td>
                </tr>
